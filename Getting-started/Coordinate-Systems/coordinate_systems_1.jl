...
function main()
    ...
    # ------------------------------------
    ourShader = Shader("./shaders/6.1.shader.vs", "./shaders/6.1.shader.fs") # you can name your shader files however you like
    ...
    while !GLFW.WindowShouldClose(window)
        ...
        view = Mat4(1.0f0)
        model = rotate(model, radians(-55.0f0), Vec3(1.0f0, 0.0f0, 0.0f0))
