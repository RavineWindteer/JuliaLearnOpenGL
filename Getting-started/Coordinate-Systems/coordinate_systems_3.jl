...
function main()
    ...
    # ------------------------------------
    ourShader = Shader("./shaders/6.3.shader.vs", "./shaders/6.3.shader.fs") # you can name your shader files however you like
    ...
    while !GLFW.WindowShouldClose(window)
        ...
        view = Mat4(1.0f0) # make sure to initialize matrix to identity matrix first
        ...
        setMat4(ourShader, "projection", projection) # note: currently we set the matrix each frame, but since the matrix rarely changes it's often best practice to set it outside the main loop only once.
